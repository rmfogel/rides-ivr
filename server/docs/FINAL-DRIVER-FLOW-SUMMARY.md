...
// 🧮 חישוב אוטומטי: anygender = total - male - female
```

#### הסרה: `~~driver-anygender-seats~~`
```javascript
...
💾 תוצאה: male=0, female=0, anygender=4 ✅
```
...
💾 תוצאה: male=3, female=3, anygender=0 ✅
```
...
💾 תוצאה: male=2, female=1, anygender=4 ✅
```
...
5. נהג עם 7 מקומות, 2 גברים, 1 נשים → anygender=4 ✅
```
